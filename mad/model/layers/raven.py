...
def naive_raven(q,k,v,s,g,initial_state,output_final_state,scale,cu_seqlens):
    raise NotImplementedError("Naive Raven is not implemented yet. Please use 'chunk' or 'fused_recurrent' mode for now.")

    chunk_o, chunk_state = chunk_raven(q, k, v, s, g, initial_state, output_final_state, scale, cu_seqlens)
    assert o == chunk_o
    assert recurrent_state == chunk_state
